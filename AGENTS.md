# AGENTS.md — Terra Reform website

Project instructions for AI coding agents (Claude Code, OpenAI Codex, Cursor,
GitHub Copilot, Gemini CLI, and others). **Read this file first — it is the single
source of truth.** `CLAUDE.md` and `.github/copilot-instructions.md` are thin
pointers to this file; do not duplicate content into them.
